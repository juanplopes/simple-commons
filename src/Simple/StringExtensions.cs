...
namespace Simple
{
    ...
    {
        public static string AsFormatFor(this string format, params object[] arg0)
        {
            return string.Format(format, arg0);
        }

        public static string AsFormatFor(this string format, IFormatProvider provider, params object[] arg0)
        {
        ...
        {
            var regex = new Regex(charSelectorRegex, RegexOptions.Compiled);
